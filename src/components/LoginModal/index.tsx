...
export const LoginModal: FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4">
      {/* Modal Container */}
      <div className="relative bg-card border-2 border-(--color-card-stroke) shadow-[4px_4px_0px_0px_var(--color-shadow)] w-full max-w-[400px] p-6 space-y-6">
        
        {/* Close Button */}
        <button
          onClick={closeLoginModal}
          aria-label="Tutup"
          className="absolute top-4 right-4 text-muted-foreground hover:text-foreground focus-visible:outline-none cursor-pointer"
        >
        ...
        <div className="flex flex-col gap-3">
          <Button
            ...
            fullWidth
            leftIcon={
              <div className="bg-white p-1 shrink-0 flex items-center justify-center w-7 h-7 rounded-full">
