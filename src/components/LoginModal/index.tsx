      ...
      <div className="relative bg-card border-2 border-(--color-card-stroke) shadow-[4px_4px_0px_0px_var(--color-shadow)] w-full max-w-[400px] p-6 space-y-6">
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className={`${BUTTON_PRESS} w-full bg-primary text-primary-foreground font-mono font-bold py-2.5 px-4 border-2 border-border flex items-center justify-center hover:bg-primary/90 transition-colors`}
          >
