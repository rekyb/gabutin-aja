// Card surfaces
export const CARD_BASE = 'bg-card border-2 border-[var(--color-card-stroke)] shadow-[4px_4px_0px_0px_var(--color-shadow)] p-6' as const
export const CARD_LIGHT_BORDER = 'border border-border p-3' as const

// Shadows (hard-edged, 0px blur — brutalist)
export const SHADOW_HARD = 'shadow-[4px_4px_0px_0px_var(--color-shadow)]' as const
export const SHADOW_MEDIUM = 'shadow-[2px_2px_0px_0px_var(--color-shadow)]' as const

// Button pressed effect (active state)
export const BUTTON_PRESS = 'shadow-[2px_2px_0px_0px_var(--color-shadow)] active:shadow-none active:translate-x-[2px] active:translate-y-[2px]' as const

// Result card border+shadow states (correct / wrong / skip)
export const BORDER_CORRECT = 'border-2 border-primary shadow-[4px_4px_0px_0px_var(--color-primary)]' as const
export const BORDER_WRONG = 'border-2 border-secondary shadow-[4px_4px_0px_0px_var(--color-secondary)]' as const
export const BORDER_SKIP = 'border-2 border-muted-foreground shadow-[4px_4px_0px_0px_var(--color-muted-foreground)]' as const
...
// Showcase badge slot
export const SHOWCASE_SLOT = 'border-2 border-border shadow-[4px_4px_0px_0px_var(--color-shadow)] p-4' as const
